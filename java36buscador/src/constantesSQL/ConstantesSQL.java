...
public class ConstantesSQL {
	...
	public static final String SQL_INSERCION_PRODUCTO = 
			"insert into tabla_productos(nombre,precio,id_categoria) "
			+ "values(?,?,?)";
	...
	public static final String SQL_SELECCION_CATEGORIAS = 
			"select * from tabla_categorias";
	
	public static final String SQL_CANTIDAD_TOTAL_PRODUCTOS = 
			"SELECT COUNT(id) as total FROM tabla_productos where tabla_productos.nombre like ?;";
